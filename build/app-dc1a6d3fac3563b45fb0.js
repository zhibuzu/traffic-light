...
/***/ function(module, exports, __webpack_require__) {
	...
	function trafficPoll(traffic) {
	    _promise2.default.resolve().then(setState.bind(null, 'wait')).then(wait.bind(null, 2000)).then(setState.bind(null, 'stop')).then(wait.bind(null, 1000)).then(setState.bind(null, 'pass')).then(wait.bind(null, 3000)).then(trafficPoll);
	};

	// 终极版
	var TrafficProtocol = function TrafficProtocol(reset) {
	...
	TrafficProtocol.prototype.reset = function () {
	    ...
	    this.fnStates.forEach(function (fnState) {
	        _this.promise = _this.promise.then(function () {
	            return new _promise2.default(function (resolve) {
	                fnState(resolve);
	            });
	        });
	    ...
	    if (this.autoreset) {
	        this.promise.then(this.reset.apply(this));
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(6)
	  ...
	  , species  = __webpack_require__(27)
	  ...
	  , asap     = process && process.nextTick || __webpack_require__(28).set
	  , P        = global[PROMISE]
	  , isFunction     = $.isFunction
	  , isObject       = $.isObject
...
/***/ }
/******/ ]);
//# sourceMappingURL=app-dc1a6d3fac3563b45fb0.js.map